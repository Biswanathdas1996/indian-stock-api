...
router.get("/matic", (req, res, next) => {
  // Set API key and base URL
  const apiKey = "ffb6b4bc-de05-4824-885f-146490325c3f";
  const baseURL = "https://pro-api.coinmarketcap.com/v1/cryptocurrency/";

  // Set endpoint and parameters
  const endpoint = "quotes/latest";
  const params = {
    symbol: "MATIC", // Replace with the symbol of the cryptocurrency you want to get data for
    convert: "INR", // Replace with the fiat currency you want to convert to
  };
  ...
  // Make the request
  axios
    .get(`${baseURL}${endpoint}`, { params, headers })
    .then((response) => {
